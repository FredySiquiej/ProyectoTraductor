...
"=" {System.out.println("Lexema:  " + yytext()  + "       columna:  " + yychar + "     fila:  " + yyline  );return symbol(sym.IGUAL, yytext());}
...
">" {System.out.println("Lexema:  " + yytext()  + "       columna:  " + yychar + "     fila:  " + yyline  );return symbol(sym.MAYOR_QUE, yytext());}
"=>" {System.out.println("Lexema:  " + yytext()  + "       columna:  " + yychar + "     fila:  " + yyline  );return symbol(sym.MAYOR_OR_IGUAL_QUE, yytext());}
"<" {System.out.println("Lexema:  " + yytext()  + "       columna:  " + yychar + "     fila:  " + yyline  );return symbol(sym.MENOR_QUE, yytext());}
...
\"([^\"\\]|\\.)*\" {System.out.println("Lexema:  " + "ID   "   + "       columna:  " + yychar + "     fila:  " + yyline  );return symbol(sym.ID, yytext());}
